...
export default function Activity() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-[60%_40%] pt-5 gap-2">
      ...
      <div>
        <div className="flex bg-white border rounded-t-[0.625rem] border-[#191D311A] items-center">
          ...
          <div className="divide-y divide-gray-200">
            ...
            <div className="flex py-4 items-start justify-between">
              <div className="flex space-x-3 items-start">
                ...
                />
                <div>
                  <p className="text-14 font-5">Uploaded a new medical certificate</p>
                  <p className="text-gray-500 font-4 text-12">
                    for <span>Robert Johnson</span>
                  </p>
                  <div className="text-xs text-[#68CFF7] hover:underline cursor-pointer">
                    <div className="flex items-center">
                      <Image
                        ...
                        width={32}
                        height={32}
                        className="mr-2 mt-2 rounded-full object-cover"
                      />
                      Admin User
                    </div>
                  </div>
              ...
              <div className="items-center xs-d-none space-x-3">
                <div className="flex justify-end mb-3">
                  <button className="flex bg-gray-900 text-white px-3 py-1 rounded text-xs hover:bg-gray-700">
                    Accept
                  </button>
                </div>
                <div className="flex">
                  ...
                  <span className="text-xs flex text-gray-400 ml-2">
                    <Image
                      src="/icon/mes.svg"
                      alt="Message"
                      width={16}
                ...
                <div className="flex justify-end mb-3">
                  <span className="text-xs flex items-center text-brand font-7 text-12 border border-brand bg-brand1 rounded px-2 py-0.5">
                    <svg xmlns="http://www.w3.org/2000/svg" className="mr-2" width="13" height="13" viewBox="0 0 13 13" fill="none">
                      <path d="M10.5801 3.45361L5.08008 8.95361L2.58008 6.45361" stroke="#68CFF7" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    Accepted by Maria Garcia
                  </span>
                </div>
                <div className="flex">
                  <span className="text-xs flex text-gray-400">
          ...
          {[1, 2, 3, 4].map((_, index) => (
            <div className="flex items-center space-x-3" key={index}>
              ...
              <div className="w-[55%] truncate">
                ...
                <p className="text-gray-500 font-4 text-12 truncate w-60">I need to add a new </p>
              </div>
